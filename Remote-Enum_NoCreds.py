...
def replace_placeholders(command, ip_address, username, domain, shortdomain, computer_name):
    ...
    for placeholder, value in replacements.items():
        if placeholder in command and value:
            command = command.replace(placeholder, value)
    return command

def generate_scripts(commands, ip_address, username, domain, shortdomain, computer_name, ports_without_commands):
...
def main():
    ...
    generate_scripts(all_commands, ip_address, username, domain, shortdomain, computer_name, ports_without_commands)
